       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <img src="assets/img/logo2.png" alt="logo" class="img-responsive" style="width: 10%;"></h1>
            </div>
            <?php
            ...
            ?>
              <div class="row">
                ...
                <?php
                    ...
                    echo '<h2 class="text-center">Estamos construyendo productos de la categoría <strong>"'.$datCat['Nombre'].'"</strong></h2>';
                  }
                ?>
              </div>
            <?php
                }else{
                  //echo '<h2 class="text-center">Seleccione la categoría que desee</h2>';

                }
              else:
                echo '<h2 class="text-center">Estamos construyendo los productos</h2>';
              endif;
            ?>
         ...
         <div class="row">
                <?php
                  ...
                  $consulta= ejecutarSQL::consultar("SELECT producto.CodigoProd,producto.NombreProd,producto.CodigoCat,categoria.Nombre,producto.Precio,producto.Descuento,producto.Stock,producto.Imagen,producto.Piezas,producto.Edad FROM categoria INNER JOIN producto ON producto.CodigoCat=categoria.CodigoCat WHERE Stock > 0 AND Estado='Activo' ORDER BY categoria.Nombre");
