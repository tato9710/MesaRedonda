...
<html lang="es">
<head>
    <title>Mesa Redonda | Administración</title>
    ...
    <section id="prove-product-cat-config">
        <div class="container">
          <div class="page-header">
            <h1>Panel de administración <img src="assets/img/logo2.png" alt="logo" class="img-responsive" style="width: 10%;"></h1>
          </div>
          <!--====  Nav Tabs  ====-->
          <ul class="nav nav-tabs nav-justified" style="margin-bottom: 15px;">
            ...
            <li>
              <a href="respaldo.php">
                <i class="fa fa-database" aria-hidden="true"></i> &nbsp; Respaldar BD
              </a>
            </li>
          </ul>
          <?php
            ...
            if(isset($content)){
              if(in_array($content, $WhiteList) && is_file("./admin/".$content."-view.php")){
                ...
                echo '<h2 class="text-center">Lo sentimos, nos hemos encontrado con un ladrillo roto</h2>';
              }
            }else{
              echo '<h2 class="text-center">Seleccione una opción a administrar</h2>';
            }
          ?>
        </div>
    </section>
