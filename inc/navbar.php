...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <!--<p class="text-navbar tittles-pages-logo">RenaTOYS</p>-->
                
                <img src="assets/img/logo1.png" alt="logo" class="img-responsive" style="width: 40%; display: block; margin: 0 auto;">
                ...
                <div class="contenedor-tr">
                  ...
                  <?php
                      if(!$_SESSION['nombreAdmin']==""){
                          ...
                          <a href="registration.php" class="table-cell-td">Sign Up</a>
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login" style="padding: 15px;">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center text-danger" id="myModalLabel">Iniciar sesión</h4>
            </div>
            <form action="process/login.php" method="post" role="form" class="FormCatElec" data-form="login">
                <div class="form-group label-floating">
                    <label class="control-label text-danger"><span class="glyphicon glyphicon-user text-danger"></span>&nbsp;Nombre</label>
                    <input type="text" class="form-control text-danger" name="nombre-login" required="">
                </div>
                <div class="form-group label-floating">
               ...
               <div class="radio">
                ...
                <div class="modal-footer">
                  <button type="submit" class="btn btn-danger btn-raised btn-sm">Iniciar sesión</button>
                  <button type="button" class="btn btn-white btn-raised btn-sm" data-dismiss="modal">Cancelar</button>
                </div>
