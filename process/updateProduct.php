...
$edadProdUp=consultasSQL::clean_string($_POST['prod-edad']);
$piezaProdUp=consultasSQL::clean_string($_POST['prod-pieza']);
...
if(consultasSQL::UpdateSQL("producto", "NombreProd='$nameProdUp',CodigoCat='$catProdUp',Precio='$priceProdUp',Descuento='$descProdUp',Edad='$edadProdUp',Piezas='$piezaProdUp',Stock='$stockProdUp',NITProveedor='$proveProdUp',Estado='$EstadoProdUp'", "CodigoProd='$codeOldProdUp'")){
   echo '<script>
    swal({
