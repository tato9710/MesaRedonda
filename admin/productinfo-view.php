                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                ...
                                <input type="text" class="form-control" value="<?php echo $prod['Piezas']; ?>" required name="prod-pieza">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Edades</label>
                                <input type="text" class="form-control" value="<?php echo $prod['Edad']; ?>" required name="prod-edad">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
