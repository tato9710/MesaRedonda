...
<html lang="es">
<head>
    <title>Mesa Redonda | Sign Up</title>
    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>Sign Up <img src="assets/img/logo2.png" alt="logo" class="img-responsive" style="width: 10%;"></h1>
            </div>
            
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/signup.png" alt="store" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
                    <div id="container-form">
                       <p class="text-center lead">Construcción de Clientes</p>
                       <br><br>
